...
PROMPT_V1_NAME = "nguyen-minh-dat-day22-rag-v1"
PROMPT_V2_NAME = "nguyen-minh-dat-day22-rag-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="Day 22 RAG prompt V1 - concise answers",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="Day 22 RAG prompt V2 - structured expert answers",
        )
...
def main():
    """Run the A/B demo and persist the console output required by the rubric."""
    buffer = io.StringIO()
